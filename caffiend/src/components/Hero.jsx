...
const Hero = () => {
    ...
    useEffect(() => {
        caffiendBenefits.forEach((benefit, index) => {
            setTimeout(() => {
                setLoadedBenefits(prev => [...prev, index]);
            }, 1000 + index * 500); // fake staggered loading
        });
    }, []);
    ...
    return (
        <>
            <h1 className='font-bold'>Coffee Tracking for Coffee <abbr title="An enthusiast or devotee">Fiends</abbr>!</h1>
            <div className="benefits-list">
                ...
                <ul className="max-w-md space-y-2 text-gray-500 list-inside dark:text-gray-400">
                    {
                        caffiendBenefits.map((benefit, index) => (
                            <li className="flex items-center" key={index}>
                                {loadedBenefits.includes(index) ? (
                                    // ✅ Checkmark icon
                                ...
                                <p style={{ paddingLeft: "5px", paddingTop: "4px" }}>{benefit}</p>
                            </li>
                        ))
                    }
                </ul>
            ...
            <div className="card info-card">
                <div>
                    <i className="fa-solid fa-circle-info" style={{ paddingTop: "4px" }}></i>
                    <h3 className='font-bold'>Did you know...</h3>
                </div>
                <h5 className='font-bolder'>That caffeine&apos;s half-life is about 5 hours?</h5>
